/* =====================================================================
   _crit-giudice.js — L'IMPIANTO DEI SETTE FALSI DEL GIUDICE
   (voce #133, compito 1). Non e' un falso: e' il pezzo che i sette
   condividono, perche' un falso e' una sostituzione e una lettera, non
   quaranta righe di argomenti della riga di comando copiate sette volte.

   UN FALSO SERVE A CONDANNARE IL BANCO, NON IL GIOCO. Il cancello
   _q-giudice.js dice che il giudice funziona; questi dicono che il
   ...
   gentile non prova niente (lezione pagata due volte in quest'onda —
   voce #131 e voce #132).
...
function falso(conf) {
  ...
  if (n !== 1) {
    ...
    if (n === 0) console.error('  Prima del compito 2 e\' NORMALE: il giudice non e\' ancora nel file.');
    process.exit(1);
  }
  ...
  console.log('    prova:  node strumenti/_q-giudice.js --gioco ' + path.relative(RADICE, outFile).replace(/\\/g, '/'));
