...
/* --gioco: la sola differenza da _z-verbo.js — misura una COPIA invece
   del gioco spedito. Nient'altro e' cambiato. */
...
(async () => {
  ...
  try {
    ...
    const pag2 = await (async () => {
      ...
      await p.goto(`http://127.0.0.1:${srv.porta}/${GIOCO}`, { waitUntil: 'load' });
