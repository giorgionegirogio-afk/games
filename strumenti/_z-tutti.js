...
const CANCELLI = [
  { nome: 'collaudo',    cmd: ['strumenti/_z-collaudo.js'],                                conta: true,  lento: false },
  { nome: 'misura',      cmd: ['strumenti/_z-misura.js'],                                  conta: true,  lento: false },
  { nome: 'senza-rete',  cmd: ['strumenti/_z-senza-rete.js'],                              conta: true,  lento: false },
  { nome: 'equita',      cmd: ['strumenti/_z-equita.js', '--partite', '10'],               conta: true,  lento: false },
  { nome: 'silhouette',  cmd: ['strumenti/_z-silhouette.js'],                              conta: true,  lento: false },
  { nome: 'folla',       cmd: ['strumenti/_z-folla.js'],                                   conta: true,  lento: false },
  { nome: 'seme',        cmd: ['strumenti/_z-seme.js'],                                    conta: true,  lento: false },
  { nome: 'gabbia',      cmd: ['strumenti/_z-gabbia.js'],                                  conta: true,  lento: false },
  { nome: 'istantanea',  cmd: ['strumenti/_z-istantanea.js', '--dir', 'istantanee-tutti'], conta: false, lento: false },
  ...
  { nome: 'volti',       cmd: ['strumenti/_z-volti.js'],                                   conta: true,  lento: true },
  /* da qui in giu': cronometrici, girano da soli */
  { nome: 'giocata',     cmd: ['strumenti/_z-giocata.js', '--tutte'],                      conta: true,  lento: false, solo: true },
  { nome: 'avvio',       cmd: ['strumenti/_z-avvio.js'],                                   conta: false, lento: true,  solo: true },
];
