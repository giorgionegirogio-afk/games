...
const GIOCO = process.env.GIOCO_PROVA ? path.resolve(process.env.GIOCO_PROVA) : path.join(RADICE, 'CALCETTO-il-gioco.html');
...
const CANCELLI = [
  { nome: 'collaudo',    cmd: ['strumenti/_q-collaudo.js'],                                conta: true,  lento: false },
  { nome: 'misura',      cmd: ['strumenti/_q-misura.js'],                                  conta: true,  lento: false },
  { nome: 'senza-rete',  cmd: ['strumenti/_q-senza-rete.js'],                              conta: true,  lento: false },
  { nome: 'equita',      cmd: ['strumenti/_q-equita.js', '--partite', '10'],               conta: true,  lento: false },
  { nome: 'silhouette',  cmd: ['strumenti/_q-silhouette.js'],                              conta: true,  lento: false },
  { nome: 'folla',       cmd: ['strumenti/_q-folla.js'],                                   conta: true,  lento: false },
  { nome: 'seme',        cmd: ['strumenti/_q-seme.js'],                                    conta: true,  lento: false },
  { nome: 'gabbia',      cmd: ['strumenti/_q-gabbia.js'],                                  conta: true,  lento: false },
  { nome: 'istantanea',  cmd: ['strumenti/_q-istantanea.js', '--dir', 'istantanee-tutti'], conta: false, lento: false },
  { nome: 'prestazione', cmd: ['strumenti/prestazione.js', '--oggi', process.env.GIOCO_PROVA || 'CALCETTO-il-gioco.html'],                             conta: false, lento: false },
  { nome: 'volti',       cmd: ['strumenti/_q-volti.js'],                                   conta: true,  lento: true },
  /* da qui in giu': cronometrici, girano da soli */
  { nome: 'giocata',     cmd: ['strumenti/_q-giocata.js', '--tutte'],                      conta: true,  lento: false, solo: true },
  { nome: 'avvio',       cmd: ['strumenti/_q-avvio.js'],                                   conta: false, lento: true,  solo: true },
];
