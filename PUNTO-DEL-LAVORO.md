...
| 5 | **LO STATO VERO, oggi**: **onda B chiusa** (#117/#121/#122/#114/#113, righe della giornata del 19). **Onda C avviata**: **#125 CHIUSO** (riga 1-4, invariant-checker, primo anello) insieme al seguito **#124 CHIUSO** (riga 2, il cambio di base di misura dei sorteggi). **RESTANO, in ordine**: il **fuzzer** (onda C-2, userà le nove invarianti come rete), il **soak** (onda C-3, 1000 partite/notte, zero violazioni). **#123** (fotosensibile per-regione) resta fuori onda, a registro. I tre caveat della riga 3 sono candidati specifici per il fuzzer. **Seguiti aperti residui, nessuno bloccante**: **#89, #97, #98, #99, #101, #102, #103, #104, #105, #106, #109, #118** |
